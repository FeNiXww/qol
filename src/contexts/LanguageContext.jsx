...
export const translations = {
  he: {
    ...
    nationalityNote: 'זו הזהות התרבותית שלך — לא בהכרח הדרכון שלך. בחר את הקהילה שאיתה אתה מזדהה.',
    ...
    newMatch: 'התאמה חדשה!',
    searchUsers: 'חיפוש משתמש',
    searchPlaceholder: 'חפש לפי שם…',
    connect: 'התחבר',
    requestSent: 'בקשת החיבור נשלחה',
  ...
  ar: {
    ...
    nationalityNote: 'هذه هويتك الثقافية — وليس بالضرورة جواز سفرك. اختر المجتمع الذي تنتمي إليه.',
    aboutYouTitle: 'عنك',
    ...
    connect: 'تواصل',
    requestSent: 'تم إرسال طلب التواصل',
  ...
  en: {
    ...
    nationalityNote: 'This is your cultural identity — not necessarily your passport. Choose the community you identify with.',
