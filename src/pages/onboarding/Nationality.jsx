  ...
  return (
    <div className="min-h-screen flex flex-col px-6 py-12 bg-white">
      ...
      <div className="mb-10">
        ...
        <h1 className="text-3xl font-black mt-6" style={{ color: theme.colors.navy }}>Who are you?</h1>
        <p className="text-gray-400 mt-2 text-sm">Your nationality shapes your language in the app.</p>
      </div>
      ...
      <div className="space-y-4 flex-1">
        {options.map(opt => (
          ...
          >
            ...
            {selected === opt.value && (
              <div className="ml-auto w-6 h-6 rounded-full flex items-center justify-center text-white" style={{ backgroundColor: theme.colors.teal }}>
                ✓
              </div>
            )}
          </button>
